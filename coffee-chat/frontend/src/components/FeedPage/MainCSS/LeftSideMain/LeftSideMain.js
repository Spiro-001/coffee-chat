    ...
    <div className="left-side-main-feed">
      <div className="profile-left-side-mini-feed">
        <div className="profile-left-side-mini-feed-top">
          ...
          <div className="picture-crop-photo-div">
            <div className="crop">
              ...
              <img
                className="profile-picture-self"
          ...
          <div className="first-last-name-div">
            <Link to={`/user/${user.id}`} className="first-last-name-a-tag">
              {user.firstName + " " + user.lastName}
            </Link>
          </div>
          <div className="job-title-user-name">{"Software Engineer"}</div>
          ...
          <div className="connection-user-feed-div">
            <Link className="link-to-a-tag-my-network" to="/mynetwork">
              <div className="row-row-row">
                ...
                <span className="blue-font-connection-badge">{"32"}</span>
              </div>
            ...
            <Link
              className="link-to-a-tag-my-network-two"
            ...
            >
              <div className="row-row-row">
                ...
                <span className="blue-font-connection-badge">{"12"}</span>
              </div>
            </Link>
          </div>
        </div>
        <div className="profile-left-side-mini-feed-third">
          ...
          <Link className="hire-me-im-a-good-worker" to="/github">
      ...
      <div className="my-recent-left-side-mini-feed">
        <div className="my-recent-left-side-mini-feed-top">
          <div className="recent-mini-feed">
            <span className="recent-title-mini-feed">Recent</span>
            <ul className="list-element-with-recent">
              <li className="recent-elements-list">
                <li-icon
                  aria-hidden="true"
                  type="group"
                  className="community-icon-group"
                  size="small"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    ...
                    data-supported-dps="16x16"
                    fill="currentColor"
                    className="community-icon-group-svg"
                    width="16"
                    height="16"
                    focusable="false"
                  >
          ...
          <div className="groups-mini-feed">
            <span className="groups-title-mini-feed">Groups</span>
          ...
          <div className="groups-mini-feed-events">
            ...
            <button className="add-event-button">
              <li-icon
                aria-hidden="true"
                type="add"
                className="plus-icon-add-event"
                size="small"
              >
                <svg
                  className="plus-svg-add-event"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 16 16"
                  data-supported-dps="16x16"
                  fill="currentColor"
          ...
          <div className="discover-networks-left-side">
            <Link
              to="mynetwork/discover-hub/"
              className="my-network-a-tag-discover"
            >
              Discover more
            </Link>
          </div>
