...
export const Comment = ({ comment, user, comments }) => {
  ...
  useEffect(() => {
    ...
    if (
      elementScope.className === "anchor-hover-like-hover-comment" &&
      !likeHover
    )
  ...
  const handleOnClickMoreSetting = (e) => {
    ...
    if (e.target.className === "more-setting-boundary") {
      e.target.parentNode.parentNode.parentNode.parentNode.parentNode.style.overflow =
        "visible";
    }
    if (e.target.className.baseVal === "") {
      e.target.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.style.overflow =
        "visible";
    }
    if (e.target.className.baseVal === "4401") {
      e.target.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.style.overflow =
        "visible";
    }
    ...
    if (e.target.className !== "more-setting-boundary") {
      if (e.target.className.baseVal === "4401") {
        moreOptionClicked
          ? (e.target.parentNode.parentNode.parentNode.nextElementSibling.style.display =
              "none")
          : (e.target.parentNode.parentNode.parentNode.nextElementSibling.style.display =
              "flex");
      } else {
  ...
  const handleOnClickEditButton = (e) => {
    if (e.target.alt === "Edit icon" && !editActive) {
      ...
      e.target.parentNode.parentNode.parentNode.parentNode.nextElementSibling.innerHTML =
        "";
      e.target.parentNode.parentNode.parentNode.parentNode.nextElementSibling.append(
        InputBoxEdit
      );
      e.target.parentNode.parentNode.parentNode.parentNode.nextElementSibling.append(
        ButtonHolderDiv
    ...
    if (
      e.target.parentNode.parentNode.parentNode.nextElementSibling.className ===
        "body-area-text-area" &&
      !editActive
    ) {
      setEditActive(true);
      ...
      e.target.parentNode.parentNode.parentNode.nextElementSibling.innerHTML =
        "";
      e.target.parentNode.parentNode.parentNode.nextElementSibling.append(
        InputBoxEdit
      );
      e.target.parentNode.parentNode.parentNode.nextElementSibling.append(
        ButtonHolderDiv
    ...
    <>
          ...
          <div className="text-box-from-user">
            <div className="top-section-of-text-from-user">
                ...
                <div className="author-name-title-text-area">
                  ...
                  {comment.userId === user.id ? (
                    <div className="author-badge-for-author">
                      <span className="author-badge-text">Author</span>
                    </div>
                  ) : (
                    ""
                  )}
              ...
              <div className="right-side-comment-options">
                ...
                <div
                  onClick={handleOnClickMoreSetting}
                  className="more-setting-boundary"
                >
            ...
            <div className="body-area-text-area">{comment.body}</div>
          </div>
        </div>
      </div>
      <div className="bottom-bar-like-reply-area">
        <div className="like-comment-button">
          <div
            className="like-button-comment-like-post"
        ...
        <div className="anchor-hover-like-hover-comment">
          <div
            className="hover-like-option-choose-emote-comment"
            onMouseEnter={(e) => {
              setLikeHover(true);
        ...
        <div className="how-many-replies">{/* 8 Replies */}</div>
      </div>
    </>
  );
};
