    ...
    return (
        <div className="post-with-photo-and-caption">
            <div className="top-author-of-post">
                <div className="profile-pic-post-post">
                    <img src={require('../../../../../assets/post/happy-businessman-isolated-handsome-man-260nw-609414131.png')} />
                </div>
            ...
            <div className="picture-or-media-attatchment">
                <img src={require('../../../../../assets/post/stock-market-ticker-shows-gains-losses-day-48714927.jpg')} />
            </div>
            ...
            <div className="bottom-button-comment-and-like">
                ...
                <div className="repost-icon-post">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="repost-medium" data-supported-dps="24x24" fill="currentColor">
