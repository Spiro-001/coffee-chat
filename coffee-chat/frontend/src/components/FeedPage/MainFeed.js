            ...
            <nav className="main-nav-bar-main-feed-nav">
                <div className="main-left-side-main-feed">
                    ...
                    <div className="input-search-main-nav-bar-feed">
                        <li-icon aria-hidden="true" type="search" class="search-global-typeahead__search-icon" size="small">
                ...
                <div className="left-side-main-feed">
                    <div className="profile-left-side-mini-feed">
                        ...
                        <div className="profile-left-side-mini-feed-top">
                            splash art here
                            <img src={require('../../assets/DEMO-USER-BACKDROP.png')}/>
                    ...
                    <div className="my-recent-left-side-mini-feed">
                        <h1>RECENT GOES HERE</h1>
                        <div className="my-recent-left-side-mini-feed-top">

                        </div>
                        <div className="my-recent-left-side-mini-feed-second">
                            
                        </div>
                        <div className="my-recent-left-side-mini-feed-third">

                        </div>
                        <div className="my-recent-left-side-mini-feed-last">
